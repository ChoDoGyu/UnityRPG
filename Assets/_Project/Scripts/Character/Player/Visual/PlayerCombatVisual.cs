...
namespace UnityRPG.Character.Player
{
    public readonly struct PlayerDodgeVisualSettings
    {
        ...
        public PlayerDodgeVisualSettings(
            float bodyDrop,
            float bodyLean,
            float handBack,
            float footSpread)
    ...
    public sealed class PlayerCombatVisual
    {
        ...
        public void UpdateDodge(float deltaTime)
        {
            ...
            Vector3 leftFootTarget =
                ...
                Vector3.forward * dodgeSettings.FootSpread;

            Vector3 rightFootTarget =
                pose.RightFootBasePosition +
                Vector3.back * dodgeSettings.FootSpread;
            ...
            float deltaTime)
        {
            ...
            Vector3 leftHandTarget =
                pose.LeftHandBasePosition +
                Vector3.back * attackSettings.LeftHandBack;

            Quaternion bodyTargetRotation =
                pose.BodyBaseRotation *
                Quaternion.Euler(
                    attackSettings.BodyLean,
                    bodyYaw,
                    0f);
            ...
            float deltaTime)
        {
            Vector3 windupOffset =
                new Vector3(
                    ...
                    -attackSettings.HandReach * 0.45f);
